...
ROOT_DIR = r'C:\Users\maxfa_000\Documents\421\clean'

os.environ['STANFORD_PARSER'] = ROOT_DIR + r'\scoring\stanford-parser'
os.environ['STANFORD_MODELS'] = ROOT_DIR + r'\scoring\stanford-parser'
os.environ['JAVA_HOME']		  = r"C:\Program Files\Java\jre1.8.0_25\bin\java.exe"
